...
function r_closet:init(v)
 ...
 function o_pushcrate:update()
  ...
  if self.hbox:overlaps(o_player.hbox) then
   local o_brokencrate = self.stage:add(isosign(self.pos, 109, vec_8_8, {obstructs=false}))
   o_brokencrate.lines = "it's busted."
   self:destroy()
  end
...
function r_subgame:init(v)
 ...
 self.o_player.spr = 034
 self.o_player.draw = mob.draw
...

