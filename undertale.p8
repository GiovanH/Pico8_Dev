...
function t_soul:drawui()
 ...
 local hpbox = bbox.fromxywh(2, 120, 60, 8)
 local hplostv = vec(hpbox.w * (perc - 1), 0)

 rectfill(mrconcatu(hpbox:grow(hplostv), 8))
 rect(mrconcatu(hpbox, 10))
 print(self.hp .. "/" .. 20, 3, 112, 9)
end
...
function b_thrown:coupdate()
 ...
 yieldn(self.delay)
 self.vel = (self.stage.o_soul.pos - self.pos) / 50
 printh(self.vel)
end
...
function st_game:init()
 ...
 self:add(t_arena(vec(32,32), 0, vec(64, 64)))
 self.o_soul = self:add(t_soul(vec(64, 64), 0, vec(7,7)))
end
...
function st_game_inspect:init(pattern)
 ...
 local arena = self:add(t_arena(vec(32,32), 0, vec(64, 64)))
 self.o_soul = self:add(t_soul(vec(64, 64), 0, vec(7,7)))

 arena.onlypattern = pattern
...
__gfx__

