...
function b_thrown:coupdate()
 ...
 yieldn(self.delay)
 self.vel = (self.stage.o_soul.pos - self.pos):norm()
end
...
function st_game:init()
 ...
 self.o_arena = self:add(t_arena(vec(32), 0, vec(64)))
 self.o_soul = self:add(t_soul(vec(64)))
...
__gfx__

